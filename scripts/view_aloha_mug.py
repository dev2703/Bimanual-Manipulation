"""Watch the physical dinner-table mug expert in the MuJoCo viewer.

On macOS, run this with mjpython so Cocoa owns the main thread.
"""
...
def main() -> None:
    ...
    try:
        with mujoco.viewer.launch_passive(env.model, env.data) as viewer:
            ...
            env.after_step = None
            print(
                f"mug pick-place success={result.success} "
